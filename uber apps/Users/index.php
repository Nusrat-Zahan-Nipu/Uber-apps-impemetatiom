    ...
    <body>  
        <div class="container">  
			...
			<div class="table-responsive">  
				<h3 align="center">All the user </h3><br />
				<span id="result"></span>
...
$(document).ready(function(){  
    ...
    $(document).on('blur', '.first_name', function(){  
        ...
        edit_data(user_id, first_name, "first_name");  
    });  
    $(document).on('blur', '.last_name', function(){  
        var id = $(this).data("id2");  
        var last_name = $(this).text();  
        edit_data(user_id,last_name, "last_name");  
    }); 
    
    $(document).on('blur', '.eamil', function(){  
